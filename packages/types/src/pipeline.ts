...
export const PIPELINE: StageDef[] = [
  {
    ...
    steps: [
      ...
      { name: "page-structuring", label: "Page Structuring", dependsOn: ["extract"], pageProgress: true },
      { name: "book-summary", label: "Book Summary", dependsOn: ["page-structuring"] },
      { name: "translation", label: "Translation", dependsOn: ["page-structuring"], pageProgress: true },
    ],
  },
  {
    name: "storyboard",
