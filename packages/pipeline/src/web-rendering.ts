 ...
 * section_render_strategies so they fall through to the default render strategy
 * instead of the activity renderer. Activity sections are still generated by
 * the LLM — they just render as regular content.
 */
