...
export function getReviewerValidationDefaultReasonMessage(
  ...
  switch (reason.kind) {
    ...
    case "speech-unavailable":
      return msg`Defaulted to N/A because Speech audio has not been generated yet.`
    case "speech-language-unavailable":
      return reason.language
        ? msg`Defaulted to N/A because no Speech audio is available for ${reason.language}.`
        : msg`Defaulted to N/A because no Speech audio is available yet.`
