...
export function AnimExport({ progress }: { progress: number }) {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg, #f7f8fc 0%, #e7ecf4 100%)",
      }}
    >
      <div
        className="absolute left-6 top-6 flex items-center gap-2 rounded-full border border-border bg-card px-2.5 py-1 shadow-sm transition-all duration-500"
        style={{
          opacity: tabletT,
      ...
      >
        ...
        <div className="flex flex-col leading-tight">
          <span className="text-[10px] font-bold text-foreground">
            Eva
            {/* eslint-enable lingui/no-unlocalized-strings -- in-book demo content is intentionally bilingual and not user-locale-driven */}
          </span>
      ...
      >
        ...
        >
          ...
          <div
            className=
            "relative flex items-center justify-between rounded-lg border border-border bg-card/90 px-2 py-1.5 backdrop-blur transition-all duration-300"
            style={{
              opacity: toolbarT,
...
function LanguagePicker({
  ...
  /* eslint-disable lingui/no-unlocalized-strings -- in-book demo content is intentionally hardcoded */
  const langs = [
  ...
  return (
    <div
      className="absolute right-1 bottom-1 z-10 flex animate-onboarding-fade-in flex-col gap-0.5 rounded-md border bg-white p-1"
      style={{
        ...
        return (
          ...
          >
            <span
              ...
              style={{
                color: isSelected || isHover ? "#db2777" : "#374151",
              }}
            >
              {l.code}
            </span>
...
function BookSpread({
  openT,
  audioActive,
  translateActive: _translateActive,
  signActive,
  glossaryActive,
  ptSelected,
  p,
  ...
  return (
    ...
    >
      <div
        className="flex flex-1 flex-col gap-1.5 border-r border-border/60 p-3"
        style={{ fontFamily: '"Times New Roman", serif' }}
      >
        <div className="flex items-center gap-1.5">
...
function SignPip() {
  return (
    <div
      className="absolute bottom-1.5 right-1.5 overflow-hidden rounded-md border-2 animate-onboarding-fade-in"
      style={{
        width: "42%",
        aspectRatio: "4/3",
        borderColor: "#2563eb",
    ...
    >
      ...
      >
        ...
        <path
          d="M5 36 Q 5 24, 18 22 L 30 22 Q 43 24, 43 36 Z"
          fill="#3b82f6"
        />
        <path
