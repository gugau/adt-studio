...
export function CarouselScene({ onNext, onBack }: OnboardingStepProps) {
  const { t } = useLingui();
  ...
  return (
    <div className="relative grid h-full w-full grid-cols-1 items-center gap-14 p-8 md:grid-cols-[1fr_1.35fr] md:px-16">
      <div>
        ...
        <button
          ...
          className="mt-4 inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-accent/60 hover:text-foreground"
        >
          {playing ? (
            <>
