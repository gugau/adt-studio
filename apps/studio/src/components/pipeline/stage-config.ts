...
export const STAGES = [
  ...
  { slug: "quizzes", label: "Activities", runningLabel: "Generating Activities", icon: Puzzle, color: "bg-orange-600", hex: "#ea580c", textColor: "text-orange-600", bgLight: "bg-orange-50", borderColor: "border-orange-200", borderDark: "border-orange-600" },
...
export const STAGE_DESCRIPTIONS: Record<NonBookStageSlug, string> = {
  ...
  quizzes: "Generate comprehension activities based on the book content.",
